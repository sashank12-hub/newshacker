# newshacker is react based app which fetches all the new stories from hackerrank api and will dispaly it,the page will refresh the content after every 3 minutes ,user is allowed to change
